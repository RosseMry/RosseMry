...
💡 **Data & Frontend Enthusiast**  
Me apasiona transformar datos e ideas en visualizaciones claras y útiles.  
Actualmente estoy reforzando mis habilidades en **Power BI**, **SQL**, **Excel** y también explorando **Angular** y **TypeScript**.
...
### 📊 Proyectos de datos
📁 En construcción... (mi portfolio de análisis con Power BI y SQL llegará pronto 🧠)

- **Ventas Dashboard – Power BI**
- **Análisis RRHH – Power BI**
- **Consultas SQL de Kaggle**
- **Excel Dashboard interactivo**

*(Serán añadidos conforme avance el plan de 8 semanas 💪)*
